!(function (e, t) {
            ...
            (P.prototype = {
                ...
                finish: function (e) {
                    for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                        ...
                        if (r.finallyLoc === e)
                            return (
                                this.complete(r.completion, r.afterLoc), A(r), v
                            );
                    }
                },
                catch: function (e) {
    ...
    function Ne(e) {
        function t(e, r, n, o) {
            ...
            return (
                ...
                s
                    ? (ce.hasOwnProp(n, i) ? (n[i] = [n[i], r]) : (n[i] = r),
                      !a)
        ...
        transformRequest: [
            function (e, t) {
                var r,
                    ...
                    i = ce.isObject(e);
                if (
                    (i && ce.isHTMLForm(e) && (e = new FormData(e)),
                    ce.isFormData(e))
                )
                        ...
                        value: function (e) {
                            ...
                            return (
                                ce.forEach(this, function (n, o) {
                                    ...
                                    if (i)
                                        return (t[i] = Be(n)), void delete t[o];
                                    var a = e
                                        ? (function (e) {
                                              return e
                                                  .trim()
    ...
    var et,
                ...
                return new Promise(function (t, r) {
                    ...
                    function u() {
                        o.cancelToken && o.cancelToken.unsubscribe(n),
                            o.signal &&
                                o.signal.removeEventListener("abort", n);
                    }
        ...
        it = function (e, t) {
                ...
                o = function (e) {
                    if (!r) {
                        ...
                        n.abort(
                            t instanceof fe
                                ? t
                                : new Je(t instanceof Error ? t.message : t)
                        );
                    }
                },
                i =
            ...
            e.forEach(function (e) {
                return (
                    e && e.addEventListener && e.addEventListener("abort", o)
                );
            });
            var s = n.signal;
            return (
    ...
    var vt = (function () {
        ...
        gt = { http: null, xhr: ot, fetch: bt };
    ce.forEach(gt, function (e, t) {
        if (e) {
            try {
        ...
        Ot = function (e) {
            for (
                ...
                if (
                    ((r = t = e[i]),
                    !Et(t) &&
                        void 0 === (r = gt[(a = String(t)).toLowerCase()]))
                )
    ...
    function xt(e) {
        return (
            ...
            Ot(e.adapter || Ce.adapter)(e).then(
                function (t) {
                    return (
                        St(e),
    ...
    Tt.transitional = function (e, t, r) {
        function n(e, t) {
            return (
                "[Axios v1.7.0] Transitional option '" +
                e +
                "'" +
                t +
                (r ? ". " + r : "")
                        ...
                        value: function (e, t) {
                            ...
                            void 0 !== n &&
                                kt.assertOptions(
                                    n,
                                    {
                                        silentJSONParsing: At.transitional(
                                            At.boolean
                                        ),
                                        forcedJSONParsing: At.transitional(
                                            At.boolean
                                        ),
                                        clarifyTimeoutError: At.transitional(
                                            At.boolean
                                        ),
                                    },
                                    !1
    ...
    var Ft = (function e(t) {
        var r = new Lt(t),
            n = x(Lt.prototype.request, r);
        return (
            ce.extend(n, Lt.prototype, r, { allOwnKeys: !0 }),
    ...
    return (
        ...
        (Ft.mergeConfig = Ze),
        (Ft.AxiosHeaders = ze),
        (Ft.formToJSON = function (e) {
            return Ne(ce.isHTMLForm(e) ? new FormData(e) : e);
        }),
        (Ft.getAdapter = Ot),
        (Ft.HttpStatusCode = Ct),
        (Ft.default = Ft),
        Ft
    );
});
